...
@endif --}}
                        ...
                        <div class="table-responsive">
                            <table id="view_salesReport" class="table table-bordered border rounded table-striped mt-3">
                                <thead>
                                    <tr>
                                        <th>S/N</th>
                                        <th>#</th>
...
<td>{{$view_product->category->category_name}}</td>
<td>{{ $view_product->product_name }}</td>
...
@endforeach --}}
    ...
    @push('scripts')
        <script>
            new simpleDatatables.DataTable("#view_salesReport", {})
        </script>
    @endpush
@endsection
